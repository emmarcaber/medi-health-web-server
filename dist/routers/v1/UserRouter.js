 ...
 */
UserRouter.post("/register", UserValidator_1.registerUserValidation, ValidateRequestMiddleware_1.validateRequest, UserController_1.registerUser);
/**
 * @swagger
 * /v1/api/login:
 *   post:
 ...
 *                       example: Server Error
 */
UserRouter.post("/login", UserValidator_1.loginUserValidation, ValidateRequestMiddleware_1.validateRequest, UserController_1.loginUser);
/**
 * @swagger
 * /v1/api/logout:
 *   post:
 ...
 *                       example: Server Error
 */
UserRouter.post("/logout", JWTAuthenticatorMiddleware_1.authenticateToken, UserController_1.logoutUser);
/**
 * @swagger
 * /v1/api/registerRole:
 *   post:
 ...
 *                       example: Server Error.
 */
UserRouter.post("/registerRole", JWTAuthenticatorMiddleware_1.authenticateToken, UserController_1.registerUserRole);
/**
 * @swagger
 * /v1/api/refresh:
 *   post:
 ...
 */
UserRouter.post("/refresh", UserController_1.refreshUserToken);
/**
 * @swagger
 ...
 *                       example: Server Error
 */
UserRouter.post("/register-patient-to-multiple-healthcare-professionals", JWTAuthenticatorMiddleware_1.authenticateToken, UserController_1.registerPatientToMultipleHealthcareProfessionals);
/**
 * @swagger
 ...
 */
UserRouter.get("/assigned-patients", JWTAuthenticatorMiddleware_1.authenticateToken, UserController_1.getAssignedPatients);
/**
 * @swagger
 ...
 */
UserRouter.get("/assigned-healthcare-professionals", JWTAuthenticatorMiddleware_1.authenticateToken, UserController_1.getAssignedHealthcareProfessionals);
/**
 * @swagger
 * /v1/api/users:
 *   get:
 ...
 */
UserRouter.get("/users", JWTAuthenticatorMiddleware_1.authenticateToken, RoleMiddleware_1.isAdmin, UserController_1.getAllUsers);
/**
 * @swagger
 * /v1/api/users/{id}:
 *   get:
 ...
 */
UserRouter.get("/users/:id", JWTAuthenticatorMiddleware_1.authenticateToken, UserController_1.getUserById);
/**
 * @swagger
 * /v1/api/upload:
 *   post:
 ...
 *                       example: "Server Error"
 */
UserRouter.post("/upload", JWTAuthenticatorMiddleware_1.authenticateToken, UserValidator_1.uploadProfilePictureValidation, ValidateRequestMiddleware_1.validateRequest, UserController_1.uploadUserProfilePicture);
/**
 * @swagger
 * /v1/api/users/{id}:
 *   put:
 ...
 */
UserRouter.put("/users/:id", JWTAuthenticatorMiddleware_1.authenticateToken, UserController_1.updateUserById);
/**
 * @swagger
 * /v1/api/users/{id}:
 *   delete:
 ...
 */
UserRouter.delete("/users/:id", JWTAuthenticatorMiddleware_1.authenticateToken, UserController_1.deleteUserById);
