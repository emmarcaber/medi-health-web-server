...
const PatientDataController_1 = require("../../controllers/v1/PatientDataController");
const JWTAuthenticatorMiddleware_1 = require("../../middlewares/JWTAuthenticatorMiddleware");
const PatientDataValidator_1 = require("../../validators/PatientDataValidator");
const ValidateRequestMiddleware_1 = require("../../middlewares/ValidateRequestMiddleware");
const PatientDataRouter = (0, express_1.Router)();
/**
 * @swagger
 * /v1/api/patient-data:
 *   get:
 ...
 */
PatientDataRouter.get("/", JWTAuthenticatorMiddleware_1.authenticateToken, PatientDataController_1.getAllPatientData);
/**
 * @swagger
 ...
 */
PatientDataRouter.get("/:patientId", JWTAuthenticatorMiddleware_1.authenticateToken, PatientDataController_1.getPatientDataByPatient);
/**
 * @swagger
 ...
 *                       example: "An error occurred while fetching patient data."
 */
PatientDataRouter.get("/:patientId/:dataId", JWTAuthenticatorMiddleware_1.authenticateToken, PatientDataController_1.getSinglePatientData);
/**
 * @swagger
 * /v1/api/patient-data:
 *   post:
 ...
 */
PatientDataRouter.post("/", JWTAuthenticatorMiddleware_1.authenticateToken, PatientDataValidator_1.createPatientDataValidation, ValidateRequestMiddleware_1.validateRequest, PatientDataController_1.createPatientData);
/**
 * @swagger
 * /v1/api/patient-data/{patientId}:
 *   put:
 ...
 */
PatientDataRouter.put("/:patientId", JWTAuthenticatorMiddleware_1.authenticateToken, PatientDataValidator_1.updatePatientDataValidation, ValidateRequestMiddleware_1.validateRequest, PatientDataController_1.updatePatientData);
/**
 * @swagger
 * /v1/api/patient-data/{patientId}:
 *   delete:
 ...
 */
PatientDataRouter.delete("/:patientId", JWTAuthenticatorMiddleware_1.authenticateToken, PatientDataController_1.deletePatientData);
exports.default = PatientDataRouter;
//# sourceMappingURL=PatientDataRouter.js.map